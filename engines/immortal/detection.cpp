...
const DebugChannelDef ImmortalMetaEngineDetection::debugFlagList[] = {
	{ Immortal::kDebugGraphics, "Graphics", "Graphics debug level" },
	{ Immortal::kDebugPath, "Path", "Pathfinding debug level" },
	{ Immortal::kDebugFilePath, "FilePath", "File path debug level" },
	{ Immortal::kDebugScan, "Scan", "Scan for unrecognised games" },
	{ Immortal::kDebugScript, "Script", "Enable debug script dump" },
	DEBUG_CHANNEL_END
};
